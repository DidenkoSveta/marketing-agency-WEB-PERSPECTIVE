   ...
   <main>
      <section class="services">
         <div class="services__block">
            <h1 class="publication__block-title">Наши<span> Услуги</span></h1>
            <h5 class="services__block-subtitle">Возьмем на себя любые задачи по продвижению вашего бизнеса в интернете:
               от создания сайта до автоматизации продаж. Над каждым проектом будет работать полноценная команда опытных
               специалистов. Передайте нам отдельные задачи или все функции отдела интернет-маркетинга — мы сделаем это
               эффективнее за счет системного подхода.</h5>
            <div class="casses__block-img"></div>
            <div class="casses-hr"></div>
            <div class="services__block-grid">
               <div class="services__block-card">
                  <img src="<?php bloginfo('template_url'); ?>/assets/img/services/services-1.png" alt="services" class="services__block-img">
                  <p class="services__block-name">Контекстная реклама</p>
               ...
               <div class="services__block-card">
                  ...
                  <p class="services__block-name">Создание сайтов</p>
                  <p class="services__block-text">Решаем задачи бизнеса, а не просто тратим бюджет. Привлекаем на сайт
                     целевых посетителей,
                     которые становятся клиентами и приносят прибыль. </p>
               ...
               <div class="services__block-card">
                  ...
                  <p class="services__block-name">SEO - продвижение</p>
                  <p class="services__block-text">Решаем задачи бизнеса, а не просто тратим бюджет. Привлекаем на сайт
                     целевых посетителей,
                     которые становятся клиентами и приносят прибыль. </p>
               ...
               <div class="services__block-card">
                  ...
                  <p class="services__block-name">Таргетированная реклама</p>
                  <p class="services__block-text">Решаем задачи бизнеса, а не просто тратим бюджет. Привлекаем на сайт
                     целевых посетителей,
                     которые становятся клиентами и приносят прибыль. </p>
               ...
               <div class="services__block-card">
                  ...
                  <p class="services__block-name">Комплексный маркетинг</p>
                  <p class="services__block-text">Решаем задачи бизнеса, а не просто тратим бюджет. Привлекаем на сайт
                     целевых посетителей,
                     которые становятся клиентами и приносят прибыль. </p>
               ...
               <div class="services__block-card">
                  ...
                  <p class="services__block-name">Индивидуальный стиль</p>
                  <p class="services__block-text">Решаем задачи бизнеса, а не просто тратим бюджет. Привлекаем на сайт
                     целевых посетителей,
                     которые становятся клиентами и приносят прибыль. </p>
               ...
               <div class="services__block-card">
                  ...
                  <p class="services__block-name">Реклама на маркетплейсах</p>
                  <p class="services__block-text">Решаем задачи бизнеса, а не просто тратим бюджет. Привлекаем на сайт
                     целевых посетителей,
                     которые становятся клиентами и приносят прибыль. </p>
               ...
               <div class="services__block-card">
                  ...
                  <p class="services__block-name">Автоматизация продаж</p>
                  <p class="services__block-text">Решаем задачи бизнеса, а не просто тратим бюджет. Привлекаем на сайт
                     целевых посетителей,
                     которые становятся клиентами и приносят прибыль. </p>
               ...
               <div class="services__block-card">
                  ...
                  <p class="services__block-name">Email - маркетинг</p>
                  <p class="services__block-text">Решаем задачи бизнеса, а не просто тратим бюджет. Привлекаем на сайт
                     целевых посетителей,
                     которые становятся клиентами и приносят прибыль. </p>
