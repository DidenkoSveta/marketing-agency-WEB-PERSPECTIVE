   ...
   <main>
         ...
         <div class="slogan__block">
            <div class="block__slogan-background">
               <div class="block__slogan">
                  <h1 class="block__slogan-title">Персонализируйте свой маркетинг с помощью<span> e-mail рассылок</span>
                  </h1>
                  <div class="block__slogan-subtitle">Компании сегодня имеют множество возможностей для раскрутки
                     бизнеса и более эффективной работы с клиентами через различные каналы коммуникаций. <br><br> Один
                     из
                     наиболее эффективных и практичных инструментов для привлечения и удержания клиентов является
                     email-маркетинг. <br><br>Email-маркетинг позволяет поддерживать постоянную коммуникацию с
                     потенциальными и
                     существующими клиентами, рассказывать о новостях компании, продвигать товары и услуги и продвигать
                     бренд.
                  </div>
            ...
            <div class="slider">
               <div class="block__slider">
                  <div class="block__slider-left block__slider-card">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-email/slide-1.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-email/slide-2.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-email/slide-3.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-email/slide-4.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-email/slide-5.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-email/slide-6.png" alt="image slider" class="block__slider-img">
                  </div>
                  <div class="block__slider-right block__slider-card">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-email/slide-7.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-email/slide-8.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-email/slide-9.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-email/slide-10.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-email/slide-11.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-email/slide-12.png" alt="image slider" class="block__slider-img">
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="privilege__block-grid quality__block-grid">
               <div class="privilege__block-card quality-card">
                  <div class="quality-card-incard">
                     ...
                     <h6 class="cases__block-name">Поддержка</h6>
                  </div>
                  <p class="quality-card-text">Консультация и поддержка в создании и оптимизации email-рассылок</p>
               </div>
               <div class="privilege__block-card quality-card">
                  <div class="quality-card-incard">
                     <img src="<?php bloginfo('template_url'); ?>/assets/svg/quality/quality-2.svg" alt="privilege" class="privilege__block-img">
                     <h6 class="cases__block-name">Аналитика</h6>
                  </div>
                  <p class="quality-card-text">Аналитика и измерение результатов ваших email-кампаний</p>
               </div>
               <div class="privilege__block-card quality-card">
                  <div class="quality-card-incard">
                     <img src="<?php bloginfo('template_url'); ?>/assets/svg/quality/quality-3.svg" alt="privilege" class="privilege__block-img">
                     <h6 class="cases__block-name">Интерактивность</h6>
                  </div>
                  <p class="quality-card-text">Разработка интерактивных email-рассылок для привлечения внимания
                     пользователей
                  </p>
               </div>
            </div>
      ...
      <section class="quality">
         <div class="quality__block">
            <h2>Какому бизнесу и зачем нужны<span> e-mail рассылки </span>?</h2>
            <div class="quality__block-lists target-grid">
               <p class="brand-text">Email рассылки просты и эффективны - они предоставляют непревзойденные возможности
                  для доставки персонализированного контента и продвижения продуктов. Они могут быть использованы для
                  рассылки новостей, акций, актуальных предложений и многого другого. Это очень эффективный способ
                  распространения информации и увеличения продаж.
               </p> <br>
               <p class="brand-text">Email рассылки просты и экономичны. Они предоставляют возможность легко и быстро
                  создавать и доставлять массовые сообщения без дополнительных затрат. Они позволяют легко отслеживать
                  результаты рассылки и дают возможность персонализировать каждое сообщение. Это позволяет продавцам
                  выбирать правильную аудиторию и привлекать внимание потенциальных покупателей.</p> <br>
               <p class="brand-text">Email рассылки позволяют продавцам лучше понять своих клиентов, создавать более
                  целенаправленные продукты и улучшать взаимодействие с клиентами. Аналитика продаж позволяет продавцам
                  отследить каждое предложение и проанализировать результаты рассылки. В общем, email рассылки
                  предоставляют непревзойденные возможности для легкого и эффективного продвижения бизнеса в b2b и b2c
                  сферах. Они предоставляют простой способ персонализации маркетинга, позволяют следить за результатами
                  рассылки и увеличивают продажи.</p>
            </div>
      ...
      <section class="steps">
         <div class="steps__block">
            <h2>Настройка системы e-mail маркетинга в компании<span><br> WEB PERSPECTIVE</span></h2>
            <div class="steps__block-grid">
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                     <div class="steps__block-number">1</div>
                     <p class="steps__block-name">Анализ потребностей клиента</p>
                  </div>
                  <ul>
                     <li class="steps__block-list">Анализ рекламных и маркетинговых целей клиента</li>
                     <li class="steps__block-list">Анализ существующей рекламной и маркетинговой стратегии клиента</li>
                     <li class="steps__block-list">Анализ целевой аудитории клиента</li>
                  </ul>
               </div>
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                     <div class="steps__block-number">2</div>
                     <p class="steps__block-name">Создание стратегии e-mail маркетинга</p>
                  </div>
                  <ul>
                     <li class="steps__block-list">Определение таргетированной аудитории</li>
                     <li class="steps__block-list">Определение целевых групп и составление списка подписчиков</li>
                     <li class="steps__block-list">Определение целей e-mail маркетинга и составление стратегии
                        достижения целей</li>
                     <li class="steps__block-list">Разработка сценариев писем</li>
                     <li class="steps__block-list">Разработка плана рассылок</li>
                  </ul>
               </div>
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                     <div class="steps__block-number">3</div>
                     <p class="steps__block-name">Поиск и выбор платформы e-mail маркетинга</p>
                  </div>
                  <ul>
                     <li class="steps__block-list">Просмотр функциональных возможностей различных платформ</li>
                     <li class="steps__block-list">Сравнение платформ по цене и функциональным возможностям</li>
                     <li class="steps__block-list">Выбор платформы e-mail маркетинга</li>
                  </ul>
               </div>
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                     <div class="steps__block-number">4</div>
                     <p class="steps__block-name">Разработка шаблонов писем</p>
                  </div>
                  <ul>
                     <li class="steps__block-list">Подбор изображений для писем</li>
                     <li class="steps__block-list">Разработка текстов для писем</li>
                     <li class="steps__block-list">Создание шаблонов писем с учетом дизайна и целей </li>
                  </ul>
               </div>
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                     <div class="steps__block-number">5</div>
                     <p class="steps__block-name">Настройка системы e-mail маркетинга</p>
                  </div>
                  <ul>
                     <li class="steps__block-list">Настройка интеграции с веб-сайтом клиента</li>
                     <li class="steps__block-list">Настройка форм подписки и автоматических сообщений</li>
                     <li class="steps__block-list">Настройка рассылки писем</li>
                  </ul>
               </div>
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                     <div class="steps__block-number">6</div>
                     <p class="steps__block-name">Тестирование системы e-mail маркетинга</p>
                  </div>
                  <ul>
                     <li class="steps__block-list">Тестирование шаблонов писем</li>
                     <li class="steps__block-list">Тестирование рассылки писем</li>
                     <li class="steps__block-list">Тестирование форм подписки и автоматических сообщений </li>
                  </ul>
               </div>
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                     <div class="steps__block-number">7</div>
                     <p class="steps__block-name">Запуск и оценка e-mail маркетинга</p>
                  </div>
                  <ul>
                     <li class="steps__block-list">Запуск системы e-mail маркетинга</li>
                     <li class="steps__block-list">Оценка результатов и мониторинг</li>
                  </ul>
               </div>
            </div>
            <hr>
