   ...
   <main>
         ...
         <div class="slogan__block">
            <div class="block__slogan-background">
               <div class="block__slogan">
                  <h1 class="block__slogan-title"><span>Автоматизация продаж:</span> повышение эффективности и рост
                     прибыли</h1>
                  <div class="block__slogan-subtitle">В современном бизнесе важно использовать современные технологии
                     для повышения эффективности и увеличения прибыли. Автоматизация продаж - один из важнейших
                     инструментов, который позволяет оптимизировать процессы и повысить качество работы.
                  </div>
            ...
            <div class="slider">
               <div class="block__slider">
                  <div class="block__slider-left block__slider-card">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-calling/slide-1.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-calling/slide-2.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-calling/slide-3.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-calling/slide-4.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-calling/slide-5.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-calling/slide-6.png" alt="image slider" class="block__slider-img">
                  </div>
                  <div class="block__slider-right block__slider-card">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-calling/slide-7.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-calling/slide-8.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-calling/slide-9.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-calling/slide-10.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-calling/slide-11.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-calling/slide-12.png" alt="image slider" class="block__slider-img">
                  </div>
               </div>
            </div>
         </div>
      ...
      <section class="quality">
         <div class="quality__block calling-block">
            <h5 class="quality__block-subtitle calling-block-subtitle">Наша команда поможет вам в полной мере
               автоматизировать ваш процесс
               продаж. Мы начнем с идентификации вашей целевой аудитории и подготовки скрипта продаж, который поможет
               вам эффективно вести переговоры с клиентами.<br><br> Затем мы настроим вашу воронку продаж, чтобы вы
               могли отслеживать каждый
               этап процесса и вовремя вносить коррективы. В конечном итоге, мы подключим для вас CRM-систему, чтобы вы
               могли в едином месте хранить всю информацию о клиентах и ваших взаимоотношениях с ними. <br><br> С нашей
               помощью вы сможете увеличить эффективность ваших продаж,
               улучшить взаимоотношения с клиентами и сэкономить свое время и ресурсы. Обратитесь к нам, и мы решим все
               ваши проблемы с автоматизацией продаж!
            </h5>
      ...
      <section class="steps">
         <div class="steps__block">
            <h2>План работы по автоматизации продаж компании<span><br> WEB PERSPECTIVE</span></h2>
            <div class="steps__block-grid">
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                     <div class="steps__block-number">1</div>
                     <p class="steps__block-name">Анализ конкурентов</p>
                  </div>
                  <ul>
                     <li class="steps__block-list">Проведем исследование рынка, чтобы понять, как ваша компания может
                        выделяться среди конкурентов.</li>
                  </ul>
               </div>
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                     <div class="steps__block-number">2</div>
                     <p class="steps__block-name">Подбор целевой аудитории</p>
                  </div>
                  <ul>
                     <li class="steps__block-list">Определим идеальных клиентов для вашего бизнеса и поможем
                        сфокусировать ваши усилия на эту аудиторию.</li>
                  </ul>
               </div>
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                     <div class="steps__block-number">3</div>
                     <p class="steps__block-name">Составление УТП</p>
                  </div>
                  <ul>
                     <li class="steps__block-list">Создадим уникальное предложение, которое поможет вам привлекать
                        клиентов и установить лояльность.</li>
                  </ul>
               </div>
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                     <div class="steps__block-number">4</div>
                     <p class="steps__block-name">Подготовка скрипта продаж</p>
                  </div>
                  <ul>
                     <li class="steps__block-list">Разработаем эффективный скрипт для ваших продаж, чтобы вы могли
                        заключать сделки с большей уверенностью.</li>
                  </ul>
               </div>
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                     <div class="steps__block-number">5</div>
                     <p class="steps__block-name">Настройка воронки продаж</p>
                  </div>
                  <ul>
                     <li class="steps__block-list">Поможем вам настроить эффективную воронку продаж, чтобы вы могли
                        провести клиентов через процесс покупки.</li>
                  </ul>
               </div>
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                     <div class="steps__block-number">6</div>
                     <p class="steps__block-name">Подбор и обучение персонала</p>
                  </div>
                  <ul>
                     <li class="steps__block-list">Подбор персонала, отбор кандидатов и обучение холодным продажам</li>
                     <li class="steps__block-list">Контроль качества работы, аналитика работы и мотивация и контроль
                        персонала</li>
                  </ul>
               </div>
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                     ...
                     <p class="steps__block-name">Подключение IP телефонии и настройка CRM системы</p>
                  </div>
                  <ul>
                     <li class="steps__block-list">Для успешной работы вашей команды продаж важно иметь надежный
                        инструмент. Это поможет вам снизить риски, увеличить продажи и улучшить качество работы.</li>
