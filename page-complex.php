   ...
   <main>
         ...
         <div class="slogan__block">
            <div class="block__slogan-background">
               <div class="block__slogan">
                  <h1 class="block__slogan-title"><span>Комплексный маркетинг</span> - лучшие специалисты для Вашего
                     бизнеса.</h1>
                  <div class="block__slogan-subtitle">Каждое управленческое решение должно быть подготовлено и
                     аргументированно и в идеале опираться на опыт. Используйте весь наш опыт для своего бизнеса!
                  </div>
            ...
            <div class="slider">
               <div class="block__slider">
                  <div class="block__slider-left block__slider-card">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-complex/slide-1.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-complex/slide-2.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-complex/slide-3.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-complex/slide-4.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-complex/slide-5.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-complex/slide-6.png" alt="image slider" class="block__slider-img">
                  </div>
                  <div class="block__slider-right block__slider-card">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-complex/slide-7.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-complex/slide-8.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-complex/slide-9.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-complex/slide-10.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-complex/slide-11.png" alt="image slider" class="block__slider-img">
                     <img src="<?php bloginfo('template_url'); ?>/assets/img/slider-complex/slide-12.png" alt="image slider" class="block__slider-img">
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="privilege__block-grid quality__block-grid">
               <div class="privilege__block-card quality-card">
                  <div class="quality-card-incard">
                     ...
                     <h6 class="cases__block-name">Принятие решений</h6>
                  </div>
                  <p class="quality-card-text">Поддержка в принятии решений в области маркетинга, детальная
                     аргументированность и ответственность!</p>
               </div>
               <div class="privilege__block-card quality-card">
                  <div class="quality-card-incard">
                     <img src="<?php bloginfo('template_url'); ?>/assets/svg/quality/quality-2.svg" alt="privilege" class="privilege__block-img">
                     <h6 class="cases__block-name">Погружение в Вашу нишу</h6>
                  </div>
                  <p class="quality-card-text">Детальное погружение наших специалистов в специфику Вашего бизнеса.</p>
               </div>
               <div class="privilege__block-card quality-card">
                  <div class="quality-card-incard">
                     <img src="<?php bloginfo('template_url'); ?>/assets/svg/quality/quality-3.svg" alt="privilege" class="privilege__block-img">
                     <h6 class="cases__block-name">Отчетность</h6>
                  </div>
                  <p class="quality-card-text">Понятная и наглядная аналитика, регулярная отчетность и полная
                     прозрачность всей проведенной работы.</p>
               </div>
            </div>
            <hr class="quality-hr">
         </div>
      ...
      <section class="quality">
         <div class="quality__block">
            <h2>Кому и зачем могут понадобиться услуги<span> комплексного маркетинга </span>?</h2>
            <div class="quality__block-lists target-grid">
               <p class="brand-text">Компании, использующие большое количество инструментов привлечения клиентов, через
                  некоторое время сталкиваются с необходимостью эффективно распределять ресурсы между различными
                  инструментами для достижения оптимальных результатов. Это требует детального погружения в специфику
                  каждого инструмента и проведения детального сравнительного анализа между ними. Что в свою очередь
                  начинает стремительно потреблять управленческий бизнеса.
               </p> <br>
               <p class="brand-text">Выходом из такой ситуации может быть найм специалиста для делегирования ему этих
                  задач. Стоимость услуг зависит от квалификации специалиста и уровня ответственности.
                  Можно найти студента и нанять его за 20 тыс. рублей, и доверить ему управление Вашим рекламным
                  бюджетом.
               </p> <br>
               <p class="brand-text">Можно найти специалиста с небольшим опытом, такой сотрудник будет стоить от 50 тыс.
                  руб., или сразу поднять планку и искать опытного специалиста, с оплатой от 150 тыс. руб., но со
                  знаниями во многих областях (в контекстной и таргетированной рекламе, SEO продвижении, создании сайтов
                  с нуля не только на шаблонах, а со знанием PHP, HTML, CSS, опытом работы в графических редакторах и
                  знанием веб - дизайна).</p> <br>
      ...
      <section class="steps">
         <div class="steps__block">
            <h2>План работ по комплексному маркетингу с компанией<span> WEB PERSPECTIVE</span></h2>
            <div class="steps__block-grid">
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                     <div class="steps__block-number">1</div>
                     <p class="steps__block-name">Определение целей бизнеса</p>
                  </div>
                  <ul>
                     <li class="steps__block-list">Определение конкретных целей и задач бизнеса</li>
                     <li class="steps__block-list">Понимание конкурентной среды и сегментации рынка</li>
                     <li class="steps__block-list">Определение аудитории и потребностей потребителей</li>
                  </ul>
               </div>
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                     <div class="steps__block-number">2</div>
                     <p class="steps__block-name">Оценка представленных инструментов маркетинга</p>
                  </div>
                  <ul>
                     <li class="steps__block-list">Оценка и анализ существующих инструментов маркетинга</li>
                     <li class="steps__block-list">Оценка и анализ потенциальных инструментов маркетинга</li>
                     <li class="steps__block-list">Оценка и анализ конкурентных преимуществ</li>
                  </ul>
               </div>
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                     <div class="steps__block-number">3</div>
                     <p class="steps__block-name">Планирование использования инструментов маркетинга</p>
                  </div>
                  <ul>
                     <li class="steps__block-list">Поиск точек роста</li>
                     <li class="steps__block-list">Разработка плана использования инструментов маркетинга</li>
                     <li class="steps__block-list">Формирование продвижения бренда</li>
                  </ul>
               </div>
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                  ...
                  <ul>
                     <li class="steps__block-list">Разработка стратегии контент - маркетинга</li>
                     <li class="steps__block-list">Разработка маркетинговой стратегии для социальных сетей</li>
                     <li class="steps__block-list">Формирование стратегии поисковой оптимизации</li>
                     <li class="steps__block-list">Определение бюджета и расходов на маркетинг</li>
                  </ul>
               </div>
               <div class="steps__block-card">
                  <div class="steps__block-incard">
                     <div class="steps__block-number">5</div>
                     <p class="steps__block-name">Разработка маркетинговой стратегии</p>
                  </div>
                  <ul>
                     <li class="steps__block-list">Оценка результатов маркетинговых кампаний</li>
                     <li class="steps__block-list">Анализ и корректировка результатов</li>
                     <li class="steps__block-list">Формирование рекомендаций и планов действий</li>
                  </ul>
               </div>
            </div>
            <hr>
